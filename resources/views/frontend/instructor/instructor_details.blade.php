            ...
            <div class="breadcrumb-content">
                <div class="media media-card align-items-center pb-4">
                    ...
                    <div class="media-body">
                        ...
                        <span class="d-block lh-18 pt-1 pb-2">Joined
                            {{ Carbon\Carbon::parse($instructor->created_at)->diffForHumans() }}</span>
                ...
                <ul class="nav nav-tabs generic-tab justify-content-center" id="myTab" role="tablist">
                    ...
                    @auth
                        <li class="nav-item">
                            ...
                            <div id="app">
                                <send-message :recevierid="{{ $instructor->id }}"
                                    receivername="{{ $instructor->name }}"></send-message>
                            </div>
                        </li>
                    @else
                        <button class="btn theme-btn d-none d-lg-inline-block"><a href="{{ route('login') }}">Login First</a></button>
                    @endauth
