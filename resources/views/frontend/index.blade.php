                    ...
                    <div class="hero-content text-right">
                        ...
                        <div class="hero-btn-box d-flex flex-wrap align-items-center pt-1 justify-content-end">
                            ...
                            <a href="admission.html" class="btn theme-btn mb-4"><i
                                    class="la la-arrow-left icon mr-1"></i>Get Enrolled
                            </a>
                        </div>
                        <!-- end hero-btn-box -->
                    </div>
            ...
            <div class="row feature-content-wrap">
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <p class="info__text">
                            Timply dummy text of the printing and typesetting industry.
                            Lorem Ipsum
                        </p>
                    </div>
                    <!-- end info-box -->
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">
                                            <a href="course-details.html">The Business Intelligence Analyst Course
                                                2021</a>
                                        </h5>
                                        <p class="card-text">
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">
                                            <a href="course-details.html">Ultimate Adobe Photoshop Training: From
                                                Beginner to
                                                Pro</a>
                                        </h5>
                                        <p class="card-text">
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">
                                            <a href="course-details.html">The Complete WordPress Website Business
                                                Course</a>
                                        </h5>
                                        <p class="card-text">
                                            <a href="teacher-detail.html">Jose Portilla</a>
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_4">
                                    ...
                                    <div class="card-body">
                                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">Beginner</h6>
                                        <h5 class="card-title">
                                            <a href="course-details.html">The Ultimate Drawing Course - Beginner to
                                                Advanced</a>
                                        </h5>
                                        <p class="card-text">
                                            <a href="teacher-detail.html">Jose Portilla</a>
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">
                                            <a href="course-details.html">The Complete Digital Marketing Course - 12
                                                Courses in
                                                1</a>
                                        </h5>
                                        <p class="card-text">
                ...
                <div class="course-carousel owl-action-styled owl--action-styled mt-30px">
                    <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">
                                <a href="course-details.html">The Complete WordPress Website Business Course</a>
                            </h5>
                            <p class="card-text">
                                <a href="teacher-detail.html">Jose Portilla</a>
                            </p>
            ...
            <div class="testimonial-carousel owl-action-styled">
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            selection of courses here. The instructors are so knowledgable
                            while being fun and interesting. Lorem ipsum dolor sit amet,
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            willing to learn real skills. This platform gives you the
                            opportunity to learn from experts at a convenient time.
                        </p>
                    </div>
                    <!-- end card-body -->
                </div>
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <!-- end media -->
                        <p class="card-text">
                            Thank you Aduca! You've renewed my passion for learning and my
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            education. This site has literally been a lifesaver as I can now
                            earn from freelance working using the skills I learned from
                            here.
                        </p>
                    </div>
                    <!-- end card-body -->
                            ...
                            <form method="post">
                                ...
                                <div class="btn-box pt-2">
                                    <button class="btn theme-btn" type="submit">
                                        Apply Now <i class="la la-arrow-right icon ml-1"></i>
                                    </button>
                                </div>
                                <!-- end btn-box -->
                            </form>
        ...
        <div class="container">
            <div class="section-heading">
                ...
                <h2 class="section__title">
                    ...
                    <a href="for-business.html" class="text-color hover-underline">Aduca for Business</a>
                    to build <br />
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item hover-s text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Teach what you love. Aduca gives you the tools to create a
                                course.
                            </p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="btn-box mt-20px">
                                <a href="for-business.html" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i
                                        class="la la-briefcase mr-1"></i>Get aduca for
                                    business</a>
                            </div>
                            <!-- end btn-box -->
                        </div>
