    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="myForm" action="{{ route('update.site') }}" method="post" class="row g-3"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="facebook" class="form-control" id="input1"
                            value="{{ $site->facebook }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="input1" class="form-label"> twitter</label>
                        <input type="text" name="twitter" class="form-control" id="input1"
                            value="{{ $site->twitter }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="input1" class="form-label"> copyright</label>
                        <input type="text" name="copyright" class="form-control" id="input1"
                    ...
                    <div class="col-md-6">
                        <img id="showImage" src="{{ asset($site->logo) }}" alt="Admin"
