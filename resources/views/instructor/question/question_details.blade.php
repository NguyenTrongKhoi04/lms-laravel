                            ...
                            <div class="chat-list">
                                <div class="list-group list-group-flush">
                                    <a href="javascript:;" class="list-group-item">
                                        <div class="d-flex">
                                            <div class="chat-user-online">
                                                <img src="{{ !empty($question->user->photo) ? url('upload/user_images/' . $question->user->photo) : url('upload/no_image.jpg') }}"
                                            ...
                                            <div class="chat-time">
                                                {{ Carbon\Carbon::parse($question->created_at)->diffForHumans() }}</div>
                                        </div>
                                    </a>
                        ...
                        <div class="d-flex ms-auto">
                            <div class="flex-grow-1 me-2">
                                <p class="mb-0 chat-time text-end">you,
                                    {{ Carbon\Carbon::parse($rep->created_at)->diffForHumans() }}</p>
